...
select @servicelineid=[ServiceLineId] from [Cargill_Audit].[dbo].[ServiceLine] where [ServiceLineName]='Retail'
...
select 'd82141a8-82bd-47a9-8896-feebb67be2c1',(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable'),'Duplicate Payment','Problem Type',1,0,'0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4','Prgx',CURRENT_TIMESTAMP,'Prgx',CURRENT_TIMESTAMP,1,0
where not exists ( select 1 from objectfieldserviceline where ServiceLineId =
(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable') and ObjectFieldId = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4');
...
insert into [dbo].[ObjectFieldServiceLine] 
select '4E0134F1-7520-415B-A1CA-31905BD396BA',(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance'),'Duplicate Payment','Problem Type',1,0,'0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4','Prgx',CURRENT_TIMESTAMP,'Prgx',CURRENT_TIMESTAMP,1,0
where not exists ( select 1 from objectfieldserviceline where ServiceLineId =
(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance') and ObjectFieldId = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4');
...
insert into [dbo].[ObjectFieldServiceLine] 
select '73D713FB-E44B-4DE1-BBFC-6FB09BEF2D0C',(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail'),'Duplicate Payment','Problem Type',1,0,'0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4','Prgx',CURRENT_TIMESTAMP,'Prgx',CURRENT_TIMESTAMP,1,0
where not exists ( select 1 from objectfieldserviceline where ServiceLineId =
(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail') and ObjectFieldId = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4');
...
select '9e025dba-5aaf-494c-a092-5aae28e1fdc5',1,(select Id from objectfieldserviceline where ServiceLineId = (select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable') and objectfieldid = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4'),'CFAB7C50-F00E-11E9-81B4-2A2AE2DBCCE4'
where not exists ( select 1 from objectfieldservicelinevalue  where objectfieldServiceLineId =
(select Id from objectfieldserviceline where ServiceLineId=(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable') and objectfieldid = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4') and ObjectFieldValueId = 'CFAB7C50-F00E-11E9-81B4-2A2AE2DBCCE4');
...
insert into [dbo].[ObjectFieldServiceLineValue] 
select '01ce3aa6-df15-44b7-b087-3c4c02b358a7',1,(select Id from objectfieldserviceline where ServiceLineId = (select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail') and objectfieldid = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4'),'CFAB7C50-F00E-11E9-81B4-2A2AE2DBCCE4'
where not exists ( select 1 from objectfieldservicelinevalue  where objectfieldServiceLineId =
(select Id from objectfieldserviceline where ServiceLineId=(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail') and objectfieldid = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4') and ObjectFieldValueId = 'CFAB7C50-F00E-11E9-81B4-2A2AE2DBCCE4');
...
insert into [dbo].[ObjectFieldServiceLineValue] 
select 'c8137e0f-d305-4128-b88e-a1b6903542e4',1,(select Id from objectfieldserviceline where ServiceLineId = (select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance') and objectfieldid = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4'),'CFAB7C50-F00E-11E9-81B4-2A2AE2DBCCE4'
where not exists ( select 1 from objectfieldservicelinevalue  where objectfieldServiceLineId =
(select Id from objectfieldserviceline where ServiceLineId=(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance') and objectfieldid = '0B1F95A6-EFF5-11E9-81B4-2A2AE2DBCCE4') and ObjectFieldValueId = 'CFAB7C50-F00E-11E9-81B4-2A2AE2DBCCE4');
...
insert into [dbo].[ObjectFieldServiceLine] 
select '88ac1916-2f80-4f16-ab8c-530172d02403',(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail'),'Key punch error','Root Cause',1,0,'04DB3078-72F9-44A7-8DA1-EF5E84887F19','Prgx',CURRENT_TIMESTAMP,'Prgx',CURRENT_TIMESTAMP,1,0
where not exists ( select 1 from objectfieldserviceline where ServiceLineId =
(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail') and ObjectFieldId = '04DB3078-72F9-44A7-8DA1-EF5E84887F19');

-- insert command for  ObjectFieldServiceLine table for inserting the data for Accounts Payable service line. It will insert only if the data is not existing for the same service line and objectfield


insert into [dbo].[ObjectFieldServiceLine] 
select 'bbcdfe57-d53b-495a-b6bd-32ddb80af0ed',(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable'),'Key punch error','Root Cause',1,0,'04DB3078-72F9-44A7-8DA1-EF5E84887F19','Prgx',CURRENT_TIMESTAMP,'Prgx',CURRENT_TIMESTAMP,1,0
where not exists ( select 1 from objectfieldserviceline where ServiceLineId =
(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable') and ObjectFieldId = '04DB3078-72F9-44A7-8DA1-EF5E84887F19');

-- insert command for  ObjectFieldServiceLine table for inserting the data for Contract Complaince service line. It will insert only if the data is not existing for the same service line and objectfield

insert into [dbo].[ObjectFieldServiceLine] 
select '1265217b-f450-46d2-9d96-5d4c9bc4a747',(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance'),'Key punch error','Root Cause',1,0,'04DB3078-72F9-44A7-8DA1-EF5E84887F19','Prgx',CURRENT_TIMESTAMP,'Prgx',CURRENT_TIMESTAMP,1,0
where not exists ( select 1 from objectfieldserviceline where ServiceLineId =
(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance') and ObjectFieldId = '04DB3078-72F9-44A7-8DA1-EF5E84887F19');

-- insert command for  ObjectFieldServiceLineValue table for inserting the data for Accounts Payable service line. It will insert only if the data is not existing for the same service line and objectfieldvalueid 

insert into [dbo].[ObjectFieldServiceLineValue] 
select '856acbb3-9a33-463b-a5d5-241bc78ced24',1,(select Id from objectfieldserviceline where ServiceLineId = (select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable') and objectfieldid = '04DB3078-72F9-44A7-8DA1-EF5E84887F19'),'A2C698B6-B789-468E-A743-7E6C726CD6EF'
where not exists ( select 1 from objectfieldservicelinevalue  where objectfieldServiceLineId =
(select Id from objectfieldserviceline where ServiceLineId=(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Accounts Payable') and objectfieldid = '04DB3078-72F9-44A7-8DA1-EF5E84887F19') and ObjectFieldValueId = 'A2C698B6-B789-468E-A743-7E6C726CD6EF');

-- insert command for  ObjectFieldServiceLineValue table for inserting the data for Contract Complaince service line. It will insert only if the data is not existing for the same service line and objectfieldvalueid 
insert into [dbo].[ObjectFieldServiceLineValue] 
select '823909c4-58e6-413b-94d3-1edb038931c5',1,(select Id from objectfieldserviceline where ServiceLineId = (select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance') and objectfieldid = '04DB3078-72F9-44A7-8DA1-EF5E84887F19'),'A2C698B6-B789-468E-A743-7E6C726CD6EF'
where not exists ( select 1 from objectfieldservicelinevalue  where objectfieldServiceLineId =
(select Id from objectfieldserviceline where ServiceLineId=(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Contract Compliance') and objectfieldid = '04DB3078-72F9-44A7-8DA1-EF5E84887F19') and ObjectFieldValueId = 'A2C698B6-B789-468E-A743-7E6C726CD6EF');

-- insert command for  ObjectFieldServiceLineValue table for inserting the data for Retail service line. It will insert only if the data is not existing for the same service line and objectfieldvalueid 
insert into [dbo].[ObjectFieldServiceLineValue] 
select 'a684f9c6-d079-4745-afe4-13b6b31dbb69',1,(select Id from objectfieldserviceline where ServiceLineId = (select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail') and objectfieldid = '04DB3078-72F9-44A7-8DA1-EF5E84887F19'),'A2C698B6-B789-468E-A743-7E6C726CD6EF'
where not exists ( select 1 from objectfieldservicelinevalue  where objectfieldServiceLineId =
(select Id from objectfieldserviceline where ServiceLineId=(select servicelineid from [Cargill_Audit].[dbo].[serviceline] where servicelinename = 'Retail') and objectfieldid = '04DB3078-72F9-44A7-8DA1-EF5E84887F19') and ObjectFieldValueId = 'A2C698B6-B789-468E-A743-7E6C726CD6EF');
...
-- update command to set the default value for problem sub type for Contract Compliance service line
